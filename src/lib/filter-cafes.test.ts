...
const cafes: FilterableCafe[] = [
  { id: "a", name: "Alpha Coffee", address: "大阪市北区梅田", area: "梅田", features: ["wifi", "quiet"], googleRating: 4.5, googleUserRatingsTotal: 100, workabilityScore: 4.1, googleUpdatedAt: "2026-01-01" },
  { id: "b", name: "Beta Cafe", address: "大阪市中央区", area: "心斎橋", features: ["wifi", "power-outlets"], googleRating: 4.5, googleUserRatingsTotal: 101, workabilityScore: 4.9, googleUpdatedAt: "2026-02-01" },
